...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "nami-coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "nami-coding-agent";
