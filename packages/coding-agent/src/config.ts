...
export function getUpdateInstruction(packageName: string): string {
	...
	switch (method) {
		case "bun-binary":
			return `Download from: https://github.com/badlogicgames/Nami/releases/latest`;
		case "pnpm":
...
export const APP_NAME: string = pkg.piConfig?.name || "nami";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".nami";
export const VERSION: string = pkg.version;

// e.g., PI_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;

const DEFAULT_SHARE_VIEWER_URL = "https://nami.dev/session/";
