 ...
 *
 * Uses react-frameui/jiti fork with virtualModules support for compiled Bun binaries.
 */
...
export async function discoverAndLoadExtensions(
	...
	// 1. Project-local extensions: cwd/.nami/extensions/
	const localExtDir = path.join(cwd, ".nami", "extensions");
