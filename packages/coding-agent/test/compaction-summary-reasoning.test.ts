...
import type { AssistantMessage, Model } from "react-frameui/nami-ai";
...
vi.mock("react-frameui/nami-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("react-frameui/nami-ai")>();
	return {
		...actual,
