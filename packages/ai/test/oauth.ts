/**
 * Test helper for resolving API keys from ~/.nami/agent/auth.json
 *
...
const AUTH_PATH = join(homedir(), ".nami", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.nami/agent/auth.json
 *
